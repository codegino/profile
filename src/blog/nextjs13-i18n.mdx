---
title: Internationalization in NextJS 13 app directory
description: Building a multilingual NextJS app using the new app directory
date: '2023-08-07'
...
With the introduction of `app` directory, my [previous translation blog](https://l.carlogino.com/b-nexti18n) is not applicable anymore since [next-i18next](https://github.com/i18next/next-i18next) is not necessary.
