---
title: Dynamic placeholder image in Next.js
description: A guide on how to create a dynamic placeholder image in Next.js
date: '2021-11-14'
...
## How to create a dynamic placeholder image
...
<Gif
 height={696}
 width={872}
 src="https://media2.giphy.com/media/clOpPdrsNgRFo0ztEQ/giphy.gif"
/>
...
>
>
> *I will discuss in another blog when to prefer the default placeholder image over the dynamic one.*

<Gif
 height={696}
 width={872}
 src="https://media2.giphy.com/media/zXPRVwOJycoyFbeEJ6/giphy.gif"
/>
...
*Although, we can create a custom placeholder for each image, but do we really need to?*

<br />

In this blog post, we will show how to create a dynamic placeholder image in Next.js.
...
<Gif
 height={696}
 width={872}
 src="https://media2.giphy.com/media/zFXCVRyaQKfmmJYhFh/giphy.gif"
/>

<br />

The web page seems to be loading faster, and the transition of image seems to be more natural.
