...
> This is for NextJS i18n which uses the `page` directory. Here is the [blog](https://l.carlogino.com/next-app-dir-i18n) for doing i18n in the new app directory.
>
