...
This is a continuation of the [previous article](https://codegino.com/blog/svelte-chromium-extension-options) about creating a Chrome Extension using Svelte and Tailwind.
