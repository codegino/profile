...
I used a dummy website I created from [one of my blogs](https://carlogino.com/blog/remix-supabase-integration) for my example. Initially, I could not see it in Google's search results even if I specifically searched for the domain using this search value `site:codegino.vercel.app`. 
...
> Check this [SEO cheatsheet](https://carlogino.com/blog/improve-website-seo)
> 
