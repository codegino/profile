...
#### There are two main steps to make your web page visible in Google's search results.
...
### Prerequisites: Make sure your website is SEO friendly  <Bookmark id="prerequisites" />
...
> For starters, Check this [SEO cheatsheet](https://codegino.com/blog/improve-website-seo)
> 
...
It would be best to have complete control here; plus, there are [other features](https://direction.com/10-google-search-console-features/) that you can use once you become the owner of the website.
<br />

I used a dummy website I created from [one of my blogs](https://codegino.com/blog/remix-supabase-integration) to test it out. Initially, I could not see it in Google's search results even if I specifically searched for the domain using this search value `site:codegino.vercel.app`. 

<Img width={890} height={797} src="https://i.imgur.com/MhK2gYN.png" />

<br />

We don't want to wait for a month or a year for our content to be visible in Google's search results.
...
<Img width={1088} height={437} src="https://i.imgur.com/fYzVcEq.png" />
...
<Img width={890} height={361} src="https://i.imgur.com/EcULuMG.png" />
...
However, we need to increase the page ranking. As the saying goes, _"The Best Place to Hide a Dead Body is Page Two of Google"_.
