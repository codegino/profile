...
```
Check this [codepen](https://codepen.io/codegino/pen/qBXKWxx)
...
```
Check this [codepen](https://codepen.io/codegino/pen/gOxKObO)
...
```
Check this [codepen](https://codepen.io/codegino/pen/vYJrBKr)
...
It could also be a combination of `componentDidMount` and `shouldComponentUpdate` mapping with the addition
...
```
Check this [codepen](https://codepen.io/codegino/pen/qBXKBeB)
...
component to a `React hooks`, and there are many other ways to do it.
...
This mapping is only useful when I'm refactoring a `class` component to be a `function` component.
