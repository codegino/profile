...
<Img height={696} width={872} src="https://media2.giphy.com/media/clOpPdrsNgRFo0ztEQ/giphy.gif"/>
...
>  &nbsp;
>
> Check this [blog](https://carlogino.com/blog/next-image-state-handling) for more info

<Img height={696} width={872} src="https://media2.giphy.com/media/zXPRVwOJycoyFbeEJ6/giphy.gif"/>
...
function BlurringImage({...}){
  ...
  return <Container>
    {hasPlaceholder && <Svg {...} />}
    <Image {...} onLoad={() => setHasPlaceholder(false)} />
  </Container>
}
```
...
<Img height={696} width={872} src="https://media2.giphy.com/media/zFXCVRyaQKfmmJYhFh/giphy.gif"/>
...
<Img height={1000} width={1884} src="https://media2.giphy.com/media/MwQqCxy9Ml0aw4bqUx/giphy.gif"/>
