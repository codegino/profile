...
- The full power of a useEffect could be seen when using a custom hook. I will discuss in another blog.

<br />

## Conclusion
React hooks provide a new and "easier" way to manage side-effects in a React application.
