...
> NOTE: At the time of this writing, I don't know why there will be an error going back and forth to the `pokemons` listing page. 
...
Link to the [repo](https://github.com/codegino/my-remix-app/tree/blog/getting-started)
