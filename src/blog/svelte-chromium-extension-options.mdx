...
This is a continuation of the [previous article](https://codegino.com/blog/svelte-chromium-extension) about creating a Chrome Extension using Svelte and Tailwind. This article will focus on adding an Options page to the extension.
...
- ✅ [Sync plugin contents without reloading](https://codegino.com/blog/svelte-chromium-extension-sync-states)
