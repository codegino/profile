...
> Check this [blog](https://carlogino.com/blog/remix-getting-started) in case you are not familiar with Remix.
...
export c"onst meta = () => {"
  return {
    //...
    "og:image": "https://carlogino.com/assets/preview.png"
  }
}
```
...
<head>
  <!--...-->
  <meta property="og:image" content="https://carlogino.com/assets/preview.png">
</head>
```
...
<head>
  ...
  <meta property="og:url" content="https://carlogino.com">
...
export c"onst meta = () => {"
  return {
    ...
    "twitter:creator": "@codegino",
    "twitter:url": "https://carlogino.com",
    ...
    "twitter:image": "https://carlogino.com/assets/preview.png",
  }
}
```
...
<head>
  ...
  <meta name="twitter:url" content="https://carlogino.com">
  ...
  <meta name="twitter:image" content="https://carlogino.com/assets/preview.png">
</head>
```
...
- [Adding your website to Google Search](https://carlogino.com/blog/adding-webpage-to-google-search-results)
- [SEO Optimization Cheat Sheet](https://carlogino.com/blog/improve-website-seo)
