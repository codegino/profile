---
title: Built-in Next.js features to handle image loading and error state
...
> please refer to this guide on [how to create a dynamic image placeholder](https://carlogino.cc/blog/next-dynamic-image-placeholder)
...
### Conclusion
When your web application displays a lot of images,
it is a good idea to give an immediate feedback to the user of what is happening.
One way to adress this is to use an alternate image to show the current state of an image.
