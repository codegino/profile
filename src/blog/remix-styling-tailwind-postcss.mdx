...
In my last [blog post](https://carlogino.com/blog/remix-styling-css), I discussed how to style a Remix app using Vanilla CSS. This blog will show how to integrate Tailwind and PostCSS into our Remix app.
...
> If you're wondering where the above file came from, that is from my last [blog post](https://carlogino.com/blog/remix-styling-css#reusable-component-style).
