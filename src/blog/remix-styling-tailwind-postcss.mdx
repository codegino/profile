...
keywords: ['remix tailwind', 'tailwind postcss', 'remix tailwind postcss', 'remix styling']
published: true
---
...
### Add scripts to `package.json` <a name="update-scripts"></a>
...
### Tailwind and App styles presets <a name="styles-presets"></a>
...
### PostCSS and Tailwind configuration <a name="styles-config"></a>
...
### Integrating styles in Remix Code <a name="remix-integration"></a>
...
### Styling a component <a name="sample-usage"></a>
