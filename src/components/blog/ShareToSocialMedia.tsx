...
const socialMedia = [
  {
    ...
    href: (blog: IBlogMetadata) =>
      `https://twitter.com/share?url=https://www.codegino.com/blog/${blog.slug}&text=${blog.title}`,
    color: '#1da1f2',
  ...
  },
  {
    name: 'Facebook',
    href: (blog: IBlogMetadata) =>
      `https://www.facebook.com/sharer/sharer.php?u=https://www.codegino.com/blog/${blog.slug}`,
    color: '#1877f2',
  ...
  },
  {
    name: 'LinkedIn',
    href: (blog: IBlogMetadata) =>
      `https://www.linkedin.com/sharing/share-offsite/?url=https://www.codegino.com/blog/${blog.slug}`,
    color: '#0a66c2',
    icon: FaLinkedin,
  },
  {
    name: 'Pinterest',
    href: (blog: IBlogMetadata) =>
      `http://pinterest.com/pin/create/button/?url=https://www.codegino.com/blog/${blog.slug}&media=${blog.bannerId}&description=${blog.title}`,
    color: '#bd081c',
    icon: FaPinterest,
  },
];
